                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <a href="{{ route('petugas.pengaduan.show', $pengaduan->id_pengaduan) }}">Tes</a>
                                <a href="{{ route('petugas.tanggapan.create', $pengaduan->id_pengaduan) }}">Tanggapan</a>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <img src="{{ asset('storage/' . $pengaduan->foto) }}" class="w-10" alt="">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    @switch($pengaduan->status)
                                        @case("0")
                                            <form action="{{ route('petugas.pengaduan.verification', $pengaduan->id_pengaduan) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                        ...
                                        @case("proses")
                                            <form action="{{ route('petugas.pengaduan.verification', $pengaduan->id_pengaduan) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <button class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Edit" type="submit">Tanggapi
                                                    <svg class="w-5 h-5 fill-purple-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/></svg>
                                                </button>
                                            </form>
                                            @break
